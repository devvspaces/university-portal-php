				...
				<div class="table-responsive table-box" id="record">
					<table id="attendance_data" class="table table-bordered table-striped">
						...
						<tbody>
							<?php
							$serial = 0;
							$s2  = mysqli_query($con, "SELECT * FROM college WHERE dean = '$my_id'");
							...
							?>
								...
								<tr>
									...
									<td></a>
										<a href="edit_faculty.php?is=<?php echo $sn ?>" class=" btn btn-pink btn-sm">Edit</span></a>
										<a href="manage_class.php?is=<?php echo $code ?>" class=" btn btn-pink btn-sm">Departments</span></a>
										<a href="manage_staff.php?is=<?php echo $code ?>&type=faculty" class=" btn btn-pink btn-sm">Staffs</span></a>
									</td>
								</tr>
